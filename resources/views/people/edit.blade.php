...
@section('content')
    ...
    <div class="container"> 
        ...
        <div class="card-body">
            <h1>Registro</h1> 
            <form method="POST" action="{{ route('people.update', $user->id) }}" enctype="multipart/form-data">
                @csrf
                <br>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="nit" type="text" class="form-control @error('nit') is-invalid @enderror" name="nit" value="{{  $user->nit }}"  autocomplete="nit" autofocus>
